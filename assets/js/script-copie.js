        ...
        element.addEventListener('click', function(){
            ...
            Cart.forEach((element,i) => {
                ...
                row.insertAdjacentHTML('afterbegin',
                    `
                <div data-cart-item="${element[0]}" class="row mb-2">
                    <div class="col-3">
                        <img src="${element[4]}" class="w-100">
                    </div>
                    <div class="col-9 col-lg-4 fs-5" data-cart-name="${element[1]}">${element[1]}</div>
                    <div class="col-lg-5">
                        <div class="row">
                            <div class="col fs-5" data-cart-price="${element[2]}">${element[2]}€</div>
                            <div class="col fs-5 text-center" data-cart-qt-id="${element[0]}" data-cart-qt="${element[3]}">${element[3]}</div>
